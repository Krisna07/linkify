...
const JobLists = [
  ...
  },
  {
    ...
    description:
      "As a Machine Learning Engineer, you'll be at the forefront of developing cutting-edge machine learning models and algorithms to power data-driven applications. Your work will involve close collaboration with data scientists and engineers to deploy models into production, ensuring they're both accurate and efficient.",
    requirements: [

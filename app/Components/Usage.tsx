...
const Usage = () => {
  ...
  return (
    <div className=" box-borde py-16 lg:flex flex-row grid place-items-center gap-8">
      <div className="lg:w-1/2 h-full grid gap-8 ">
        ...
        <div className="flex items-center gap-4">
          <div className="w-1/2 h-fit flex-col flex  font-[600] relative">
            <span className="w-[2px] absolute h-full bg-black -left-4 flex items-center justify-center">
              <span
                className={`w-[4px] h-1/${usages.length} bg-red-600 absolute  transition-all transition-ease`}
      ...
      <div className="lg:w-1/2 h-[fit-content] flex items-center gap-4">
        <div className="grid gap-4">
          ...
          <h2 className="font-[700] text-3xl ">Lorem ipsum dolor sit amet.</h2>
          <p>

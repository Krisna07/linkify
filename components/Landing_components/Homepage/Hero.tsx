...
export default function Hero() {
  ...
  return (
    <motion.section
      ...
      className="w-full relative grid min-h-screen place-items-center overflow-hidden text-white   border-box"
    >
      <div className="relative z-10 flex flex-col items-center">
        <motion.button
          ...
          className=" animate-slidein300  mb-1.5 inline-block rounded-full bg-accent/50  px-3 py-1.5 text-sm overflow-hidden cursor-default"
        >
          Try Demo
        </motion.button>
        <h1
        ...
        <p className="text-accent animate-slidein500 my-6 max-w-xl text-center text-base leading-relaxed md:text-lg md:leading-relaxed">

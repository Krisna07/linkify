...
const Homenav = ({ list, changeView, updateBoard }: HomeNavProps) => {
  ...
  return (
    <>
      <div className="min-w-full   grid tablet:grid-cols-[4fr_230px] p-2 tablet:p-0 grid-cols-1 tablet:gap-2 gap-4 box-border place-items-center  bg-accent/50 rounded-lg top-0 sticky z-20">
